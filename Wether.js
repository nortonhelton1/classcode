...
// Find coordinate of user and fetch weather information based on location ( https://ipapi.co/json/)
...
function getWeatherInfo(cName) {
    const WEATHER_URL = `https://api.openweathermap.org/data/2.5/weather?q=${cName}&appid=9a2159f2448b0bf63e982944eaaab85b&units=imperial`
    fetch(WEATHER_URL)
        .then(response => {
